...
object ContextUtils {
    ...
    fun getStubRecipe(): Recipe = Recipe(1, "Пицца", "Для большой компании",
    ...
    fun getStubRecipeList(): List<Recipe> = listOf(
            Recipe(1, "Пицца", "Для большой компании", null,
    ...
    fun getStubUser(): User =
            User(1, "username", "name", "pass", "email",
    ...
    fun getStubRestaurants(): List<Restaurant> = listOf(
            Restaurant(0, "Золотая бухта", "Украинская",
